  ...
  <div id="main-container">
    ...
    <div id="nav-container-hugger">
      <navOneApp
        ...
        @connectWallet="connectingToWallet = $event"
      />
      <navTwoApp
        @blockWasSearched="blockSearch = $event"
        class="nav-two"
        ref="navTwoBar"
      />
    </div>
    ...
    <div id="main-content-container">
      <div class="left-of-main-box">
        ...
        <div
          class="block-card"
          v-else-if="!loading && searchedMultiple"
          v-for="block in blockItems"
          v-bind:key="block"
        >
          ...
          <div class="left-of-blockcard">
            <div class="block-pic-hugger">
              <img
                class="block-pic"
                :src="getImgUrl(block.meta.attributes[0].value)"
              />
            </div>
            <div class="mint-date">
        ...
        <div class="block-card" v-else-if="!loading && !searchedMultiple">
          ...
          <div class="left-of-blockcard">
            <div class="block-pic-hugger">
              <img
                class="block-pic"
                :src="getImgUrl(this.blockInfo.meta.attributes[0].value)"
              />
            </div>
            <div class="mint-date">
          ...
          <div class="right-of-blockcard">
            ...
            <div class="card-owner-title">
              <p>Owned by: {{ this.blockInfo.owners[0] }}</p>
            </div>
            <div class="comment-container">
              <p>
            ...
            <div class="details-container">
              <details>
                ...
                <ul>
                  <li>
                    {{ this.blockInfo.meta.attributes[0].value }} transactions
                  </li>
      ...
      <div class="right-of-main-box">
        <img
          class="mew-icon"
          src="../assets/images/icon-mew-wallet.f29574d3.png"
        />
        <img
          class="mint-blob-block"
          src="../assets/images/block_img.png"
          alt=""
        />
        <div class="pulse"></div>
        <div class="mint-box">
